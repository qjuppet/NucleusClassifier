package ch.epfl.nuclei_classifier.plugin;
...
import ch.epfl.nuclei_classifier.config.NCConfig;
import ch.epfl.nuclei_classifier.config.NCModel;
import ch.epfl.nuclei_classifier.measure.CellInformation;
import ch.epfl.nuclei_classifier.measure.MeasureExtractor;
import ch.epfl.nuclei_classifier.measure.MeasureExtractor.FeatureK;
import ch.epfl.nuclei_classifier.measure.TextureAnalyzer;
import ch.epfl.nuclei_classifier.utils.FeatureRenderer;
...
@Plugin(type = Command.class, label = "Measure Information", menu = {
		...
		@Menu(label = "Nuclei Classification"),
